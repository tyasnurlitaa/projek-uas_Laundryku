...
<div class="container-fluid content-wrapper-aesthetic py-4">
    <!-- Header Page -->
    <div class="mb-4">
        <h2 class="page-title mb-1">Edit Layanan / Paket</h2>
        <p class="text-muted mb-0" style="font-size: 0.9rem;">Perbarui data tarif atau durasi pengerjaan untuk paket terpilih</p>
    </div>
            ...
            <div class="card card-aesthetic">
                <div class="card-header-aesthetic">
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-pencil-square" style="color: var(--caramel-primary); font-size: 1.1rem;"></i>
                        <h6 class="card-header-title">Form Edit Layanan: {{ $layanan->nama_layanan }}</h6>
                    </div>
                </div>
                        ...
                        <div class="form-group-aesthetic">
                            ...
                            <div class="input-group-aesthetic">
                                <input type="number" 
                                       ...
                                       id="estimasi_hari" 
                                       name="estimasi_hari" 
                                       value="{{ old('estimasi_hari', $layanan->estimasi_hari) }}" 
                                       required>
