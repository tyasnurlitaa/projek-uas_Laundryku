    ...
    <div class="login-page-wrapper">
        <div class="login-split-card">
            ...
            <div class="login-left-panel">
                ...
                <div class="login-illustration">
                    <svg viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="220" cy="220" r="70" fill="#FFFFFF" stroke="#B4966E" stroke-width="8"/>
                        <circle cx="220" cy="220" r="26" fill="#FAF6F0"/>
                        <rect x="240" y="205" width="140" height="30" rx="10" fill="#FFFFFF" stroke="#B4966E" stroke-width="8"/>
                        <rect x="330" y="198" width="26" height="44" rx="6" fill="#FFFFFF" stroke="#B4966E" stroke-width="6"/>

                        <path d="M180 340 C220 310, 280 310, 320 340" stroke="#B47B5F" stroke-width="8" stroke-linecap="round" fill="none"/>
                        <circle cx="180" cy="340" r="6" fill="#B47B5F"/>
                        <circle cx="320" cy="340" r="6" fill="#B47B5F"/>
                    </svg>
                </div>

                <div class="login-info-card">
                    <h6>Atur Ulang Password</h6>
                    <p>Buat password baru yang kuat untuk menjaga keamanan akun LaundryKu Anda.</p>
                </div>
            </div>
            ...
            <div class="login-right-panel">
                ...
                <p class="login-heading-sub">Masukkan password baru Anda di bawah ini.</p>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="form-label-aesthetic">{{ __('Confirm Password') }}</label>
                        <div class="input-group-aesthetic">
                            <i class="bi bi-lock-fill"></i>
                            <input id="password_confirmation" class="form-control-aesthetic" type="password" name="password_confirmation"
                                   required autocomplete="new-password" placeholder="••••••••">
                        </div>
