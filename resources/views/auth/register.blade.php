        ...
        <div class="login-split-card">
            ...
            <div class="login-left-panel">
                ...
                <div class="login-info-card">
                    <h6>Bergabung Bersama Kami</h6>
                    <p>Daftar sekarang dan nikmati kemudahan mengelola pesanan laundry Anda kapan saja, di mana saja.</p>
                </div>
            </div>

            <!-- RIGHT PANEL -->
            <div class="login-right-panel">
                <a href="{{ route('login') }}" class="login-top-link">
                    Sudah Punya Akun? Masuk
                </a>

                <h2 class="login-heading">Buat Akun Baru</h2>
                <p class="login-heading-sub">Lengkapi data di bawah ini untuk mendaftar.</p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="form-label-aesthetic">{{ __('Nama Lengkap') }}</label>
                        <div class="input-group-aesthetic">
                            <i class="bi bi-person-fill"></i>
                            <input id="name" class="form-control-aesthetic" type="text" name="name"
