...
<div class="container-fluid content-wrapper-aesthetic py-4">
    <!-- Header Page -->
    <div class="mb-4">
        <h2 class="page-title mb-1">Tambah Pelanggan Baru</h2>
        <p class="text-muted mb-0" style="font-size: 0.9rem;">Daftarkan identitas pelanggan baru untuk memudahkan pencatatan transaksi laundry</p>
    </div>
            ...
            <div class="card card-aesthetic">
                <div class="card-header-aesthetic">
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-person-plus-fill" style="color: var(--sage-primary); font-size: 1.1rem;"></i>
                        <h6 class="card-header-title">Form Isian Profil Pelanggan</h6>
                    </div>
                </div>
